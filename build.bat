@echo off
REM Build QuickCleanup.dll...

set "DESTINATION_DIR=C:\Users\Pseudonym_Tim\Desktop\Tools\Mewtator\mods\QuickCleanup"
...
echo Building QuickCleanup.dll...

cl /LD /O2 /MT /GS- /W3 /D_CRT_SECURE_NO_WARNINGS /TC src\main.c src\game_strings.c src\scene.c src\button.c /Fe:QuickCleanup.dll /link user32.lib
...
del /Q *.obj QuickCleanup.lib QuickCleanup.exp 2>nul
...
copy /Y QuickCleanup.dll "%DEPLOY_DIR%\QuickCleanup.dll"
